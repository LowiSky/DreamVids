...
<html>
	...
	<head>
		...
		<title>Contributeurs - DreamVids</title>
	</head>
		...
		<div id="page">
			...
			<div class="content">
				...
				<ul class="contributors">
					...
					<li>
						<a target="_blank" href="https://twitter.com/p_cauty" class="left"><img class="avatar" src="http://phpeter.legtux.org/uploads/avatar.jpg"></a>
						<a target="_blank" href="https://twitter.com/p_cauty"><h1>Peter</h1></a>
						<div class="description">19 ans, étudiant en L2 info, je me passionne pour l'automobile et l'informatique, je suis l'initiateur et co-fondateur de DreamVids. J'assure la gestion du projet, de l'équipe et une partie du code (programmation)</div>
					</li>
					...
					<li>
						<a class="left" target="_blank" href="https://twitter.com/DimouDev"><img class="avatar" src="https://pbs.twimg.com/profile_images/446259355537518592/vps17_hq.png"></a>
						<a target="_blank" href="https://twitter.com/DimouDev"><h1>Dimou</h1></a>
						<div class="description">Jeune développeur front-end de 14 ans, a réalisé le DreamPlayer et a participé au développement de la v2. Fondateur de <a href="http://incroya.bl.ee/ColorChemistry/">Color Chemistry</a>.</p>
					</li>

					<li>
						<a class="left" target="_blank" href="https://twitter.com/Stornitz"><img class="avatar" src="https://pbs.twimg.com/profile_images/420266828368068609/7CHDztuB.png"></a>
						<a target="_blank" href="https://twitter.com/Stornitz"><h1>Stornitz</h1></a>
						<div class="description">Jeune lycéen de 15 ans qui a pour passion l'informatique. Actuellement en 1ère S SI,il envisage par la suite des études d'ingénieur informatique, il a développé une <a href="https://github.com/JamesHemeryfr/DreamVids_API">API</a> et un <a href="http://stornitz.fr/DreamVids/">lecteur externe</a>.</div>
					</li>
